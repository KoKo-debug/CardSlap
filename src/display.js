...
export default class Display {
    ...
    render(mainPile, players) {
        ...
        tapMainPile.innerHTML = "Main pile " + mainPile.length;
        ...
        tapOwnPile.innerHTML = "Your pile " + players[0][1].pile.length;
        
        const comp1Pile = document.getElementById("comp1Pile");
        comp1Pile.innerHTML = "Computer 1's pile " + players[1][1].pile.length;
